...
_TRANSLATIONS = {
    ...
    "page.monitor_request": {"id": "Monitor Request", "en": "Monitor Request"},
    ...
    "bt.03_request": {
        "id": "Pengelolaan dan analisis permintaan talent: karakteristik, distribusi, remunerasi, dan prioritas.",
        "en": "Talent request management and analysis: characteristics, distribution, remuneration, and priority.",
    },

    # overview page — bt-07 section
    "overview.section1_title": {"id": "Ringkasan Sistem", "en": "System Summary"},
    "overview.section1_sub": {"id": "Gambaran menyeluruh kinerja sistem placement mahasiswa dari semua aspek", "en": "Complete overview of student placement system performance across all aspects"},
    "overview.section2_title": {"id": "Rekapitulasi Placement", "en": "Placement Recapitulation"},
    "overview.section2_sub": {"id": "Analisis distribusi penempatan mahasiswa sesuai kebutuhan evaluasi institusi (BT-07)", "en": "Student placement distribution analysis for institutional evaluation purposes (BT-07)"},
    "overview.bt07_chart_selector": {"id": "Tampilkan grafik:", "en": "Show chart:"},
    "overview.bt07_by_semester": {"id": "Per Semester", "en": "By Semester"},
    "overview.bt07_by_prodi": {"id": "Per Program Studi", "en": "By Study Program"},
    "overview.bt07_by_company": {"id": "Per Perusahaan (Top 10)", "en": "By Company (Top 10)"},
    "overview.bt07_by_type": {"id": "Per Jenis Penempatan", "en": "By Placement Type"},
    "overview.bt07_placement_semester": {"id": "Placement per Semester", "en": "Placement by Semester"},
    "overview.bt07_placement_prodi": {"id": "Placement per Program Studi", "en": "Placement by Study Program"},
    "overview.bt07_placement_company": {"id": "Top 10 Perusahaan berdasarkan Jumlah Placement", "en": "Top 10 Companies by Placement Count"},
    "overview.bt07_placement_type": {"id": "Placement per Jenis Penempatan", "en": "Placement by Type"},
    "overview.bt07_note": {
        "id": "Untuk analisis yang lebih lengkap dan komparasi antar periode, lihat **Laporan Periodik PDF** di bawah.",
        "en": "For more complete analysis and period-over-period comparison, see the **Periodic PDF Report** below.",
    },
    "overview.section1_chart_label": {"id": "Tampilkan ringkasan:", "en": "Show summary:"},
    "overview.s1_placement_trend": {"id": "Tren Placement Bulanan", "en": "Monthly Placement Trend"},
    "overview.s1_eligibility": {"id": "Kelayakan Mahasiswa", "en": "Student Eligibility"},
    "overview.s1_stage_funnel": {"id": "Funnel Tahapan Seleksi", "en": "Selection Stage Funnel"},
    "overview.s1_data_health": {"id": "Kualitas Data", "en": "Data Health"},
    ...
    "mc.city_location": {"id": "Kota / Lokasi", "en": "City / Location"},
    "mc.placement_status": {"id": "Status Placement", "en": "Placement Status"},
    ...
    "mc.kpi_companies_requested": {"id": "Total Mitra", "en": "Total Partners"},
    "mc.kpi_active_contacts": {"id": "Mitra Aktif", "en": "Active Partners"},
    "mc.kpi_placed_partners": {"id": "Mitra Placement", "en": "Placed Partners"},
    "mc.kpi_total_placements": {"id": "Total Placement", "en": "Total Placements"},
    "mc.kpi_avg_headcount": {"id": "Avg Demand", "en": "Avg Demand"},
    ...
    "mc.top10_ghosting": {"id": "Top 10 Perusahaan: Ghosting Tertinggi", "en": "Top 10 Companies by Ghosting Rate"},
    "mc.top10_ghosting_sub": {"id": "Perusahaan dengan kandidat paling banyak tidak merespons (berdasarkan volume & rate)", "en": "Companies with the most non-responsive candidates (by volume & rate)"},
    "mc.table_company_title": {"id": "Direktori Perusahaan Mitra", "en": "Partner Company Directory"},
    "mc.table_company_sub": {"id": "Ringkasan kinerja seluruh perusahaan mitra: permintaan, pengiriman kandidat, placement, dan ghosting", "en": "Performance summary of all partner companies: requests, candidate submissions, placements, and ghosting"},
    "mc.search_company": {"id": "Cari perusahaan", "en": "Search company"},
    "mc.search_company_placeholder": {"id": "Nama, industri, atau kota...", "en": "Name, industry, or city..."},
    "mc.table_showing": {"id": "Menampilkan {shown} dari {total} perusahaan", "en": "Showing {shown} of {total} companies"},
    "mc.col_company_name": {"id": "Nama Perusahaan", "en": "Company Name"},
    "mc.col_industry": {"id": "Industri", "en": "Industry"},
    "mc.col_scale": {"id": "Skala", "en": "Scale"},
    "mc.col_type": {"id": "Tipe", "en": "Type"},
    "mc.col_city": {"id": "Kota", "en": "City"},
    "mc.col_requests": {"id": "Jml Request", "en": "Requests"},
    "mc.col_headcount": {"id": "Headcount Diminta", "en": "Headcount Req."},
    "mc.col_sent": {"id": "Kandidat Dikirim", "en": "Candidates Sent"},
    "mc.col_placement": {"id": "Placement", "en": "Placements"},
    "mc.col_ghosting": {"id": "Ghosting", "en": "Ghosting"},
    "mc.col_fulfillment": {"id": "Fulfillment (%)", "en": "Fulfillment (%)"},

    # monitor request page (bt-03 talent request analytics)
    "mr.caption": {
        "id": "Analisis mendalam permintaan talent: karakteristik, distribusi, remunerasi, dan prioritas",
        "en": "In-depth talent request analysis: characteristics, distribution, remuneration, and priority",
    },
    "mr.total_requests": {"id": "Total Permintaan", "en": "Total Requests"},
    "mr.total_headcount": {"id": "Total Headcount", "en": "Total Headcount"},
    "mr.candidates_sent": {"id": "Kandidat Dikirim", "en": "Candidates Sent"},
    "mr.fulfillment_rate": {"id": "Tingkat Pemenuhan", "en": "Fulfillment Rate"},
    "mr.avg_response": {"id": "Rata-rata Waktu Respons", "en": "Avg Response Time"},
    "mr.days": {"id": "hari", "en": "days"},
    "mr.characteristics_title": {"id": "Karakteristik & Kebutuhan Talent", "en": "Talent Characteristics & Demand"},
    "mr.characteristics_sub": {"id": "Rincian model kerja, durasi, program studi, dan tools yang dibutuhkan", "en": "Breakdown of working models, duration, study programs, and required tools"},
    "mr.chart_type_dist": {"id": "Distribusi Jenis Penempatan", "en": "Placement Type Distribution"},
    "mr.chart_type_dist_sub": {"id": "Komposisi jenis penempatan yang ditawarkan", "en": "Composition of offered placement types"},
    "mr.chart_working_arr": {"id": "Distribusi Working Arrangement", "en": "Working Arrangement Distribution"},
    "mr.chart_working_arr_sub": {"id": "Komposisi model kerja (WFO, WFH, Hybrid)", "en": "Working arrangement composition (WFO, WFH, Hybrid)"},
    "mr.chart_duration": {"id": "Distribusi Durasi Program", "en": "Program Duration Distribution"},
    "mr.chart_duration_sub": {"id": "Komposisi durasi penempatan (dalam bulan)", "en": "Composition of placement durations (in months)"},
    "mr.ops_title": {"id": "Operasional & Pipeline", "en": "Operations & Pipeline"},
    "mr.ops_sub": {"id": "Status pipeline permintaan dan sumber pengajuan", "en": "Request pipeline status and submission sources"},
    "mr.chart_pipeline": {"id": "Pipeline Progress Permintaan", "en": "Request Progress Pipeline"},
    "mr.chart_pipeline_sub": {"id": "Status penyelesaian seluruh talent request saat ini", "en": "Current completion status of all talent requests"},
    "mr.chart_sumber_form": {"id": "Sumber Form Permintaan", "en": "Request Form Source"},
    "mr.chart_sumber_form_sub": {"id": "Platform asal pengajuan talent request", "en": "Origin platform of talent requests"},
    "mr.demand_title": {"id": "Analisis Kebutuhan", "en": "Demand Analysis"},
    "mr.demand_sub": {"id": "Program studi dan tools yang paling banyak diminta perusahaan", "en": "Study programs and tools most frequently requested by companies"},
    "mr.chart_prodi_demand": {"id": "Kebutuhan Program Studi", "en": "Study Program Demand"},
    "mr.chart_prodi_demand_sub": {"id": "Program studi yang paling sering diminta oleh perusahaan", "en": "Most frequently requested study programs"},
    "mr.chart_tools_demand": {"id": "Kebutuhan Tools & Keahlian", "en": "Tools & Skills Demand"},
    "mr.chart_tools_demand_sub": {"id": "Tools yang paling sering muncul dalam deskripsi requirement", "en": "Most frequent tools in requirement descriptions"},
    "mr.salary_title": {"id": "Analisis Gaji & Remunerasi", "en": "Salary & Remuneration Analysis"},
    "mr.salary_sub": {"id": "Sebaran remunerasi, distribusi gaji, dan rata-rata berdasarkan kategori", "en": "Remuneration spread, salary distribution, and averages by category"},
    "mr.chart_remuneration": {"id": "Tipe Remunerasi", "en": "Remuneration Type"},
    "mr.chart_remuneration_sub": {"id": "Proporsi permintaan Paid, Uang Transport, dan Non-Paid", "en": "Proportion of Paid, Transport-only, and Non-Paid requests"},
    "mr.chart_salary_dist": {"id": "Distribusi Gaji Ditawarkan", "en": "Offered Salary Distribution"},
    "mr.chart_salary_dist_sub": {"id": "Sebaran nilai nominal remunerasi (Rp)", "en": "Distribution of nominal remuneration values (Rp)"},
    "mr.chart_salary_avg": {"id": "Rata-rata Gaji per Kategori", "en": "Average Salary by Category"},
    "mr.chart_salary_avg_sub": {"id": "Rata-rata gaji tertinggi berdasarkan program studi atau tools", "en": "Highest average salary by study program or tools"},
    "mr.detail_title": {"id": "Detail Talent Request", "en": "Talent Request Details"},
    "mr.detail_title_sub": {"id": "Daftar lengkap seluruh talent request beserta status dan prioritas", "en": "Complete list of all talent requests with status and priority"},
    "mr.search_label": {"id": "Cari perusahaan atau posisi...", "en": "Search company or position..."},
    "mr.search_placeholder": {"id": "Ketik nama perusahaan atau posisi", "en": "Type company name or position"},
    "mr.no_data_filter": {"id": "Tidak ada data yang sesuai dengan filter yang dipilih.", "en": "No data matches the selected filters."},
    "mr.showing_records": {"id": "Menampilkan {shown} dari {total} record", "en": "Showing {shown} of {total} records"},
    "mr.placement_type": {"id": "Jenis Penempatan", "en": "Placement Type"},
    "mr.industry_sector": {"id": "Sektor Industri", "en": "Industry Sector"},
    "mr.company_scale": {"id": "Skala Perusahaan", "en": "Company Scale"},
    "mr.request_progress": {"id": "Progress Permintaan", "en": "Request Progress"},
    "mr.date_range": {"id": "Rentang Tanggal Permintaan", "en": "Request Date Range"},
    "mr.count": {"id": "Jumlah", "en": "Count"},
    "mr.total_headcount_req": {"id": "Total Headcount Diminta", "en": "Total Headcount Requested"},
    ...
    "mp.category_filter": {"id": "Filter Kategori Progres", "en": "Progress Category Filter"},
    "mp.pipeline_attrition": {"id": "Pipeline Attrisi", "en": "Pipeline Attrition"},
    "mp.ghost_sub": {"id": "Proporsi ghosting dan follow-up pada kandidat aktif", "en": "Proportion of ghosting and follow-up among active candidates"},

    # data sync page
    "dq.staleness_sub": {"id": "Distribusi keusangan sinkronisasi data mahasiswa", "en": "Distribution of student data sync staleness"},
    ...
    "ds.section2_sub": {"id": "Data mentah menggunakan status 'Finish' secara umum. Data ini direklasifikasi menggunakan kolom 'rejection' untuk menampilkan hasil yang sebenarnya.", "en": "The raw data used 'Finish' as a catch-all close-out status. These records are reclassified using the 'rejection' column to reveal the true outcome."},
